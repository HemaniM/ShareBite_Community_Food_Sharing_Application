const Login = () => {
  return (
    <div>
      ...
      <div className="flex justify-center">
        <button className="w-[300px] border hover:border-[#bfbfbd] py-2 rounded-2xl flex items-center justify-center gap-3 transition-all duration-200 hover:bg-[#FFFBEC] bg-[#FFFBEC] text-sm">
