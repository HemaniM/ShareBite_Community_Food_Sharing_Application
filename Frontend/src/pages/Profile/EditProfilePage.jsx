...
const EditProfilePage = () => {
  ...
  return (
    <>
      <div className="w-full max-w-[975px] mx-auto px-4 sm:px-6 lg:px-8 pb-16 mt-[50px]">
          ...
          <div className="w-full space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full h-[34px] rounded-[5px] border border-[#eceade] bg-[var(--primary-green-50)] px-3 text-[14px] text-[#7d7d77]"
              />
            </div>
